...
import { UPLOAD_STUDENT_TABLE } from '../../Config/table';

const UploadstudentsSchema = {
  // Step 1 Fields
  firstName: {
...
export default sequelizeInstance.define(UPLOAD_STUDENT_TABLE, UploadstudentsSchema, {
  timestamps: true,
